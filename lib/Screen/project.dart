  ...
  Widget projectCard(
    ...
    return SizedBox(
      ...
      child: GestureDetector(
        ...
        child: Card(
          color: const Color(0xff262628),
          // color: const Color.fromARGB(255, 4, 4, 227),
          ...
          child: Column(
            ...
            children: [
              ...
              projectCard(
                ...
                // 'https://sanjiv0286.github.io/My-CV/',
                'https://github.com/sanjiv0286/My-CV',
              ),
              projectCard(
                'Flutter, Dart, Android Studio, Vs Code, Android Emulator',
                'Calculator App',
              ...
              projectCard(
                'Flutter, Dart, Android Studio, Vs Code, Android Emulator, PHP, SQL, MySQL, XAMPP local host server, Rest API, Getx Statemanagement',
                'EasyCart - An Online Clothes Shop App',
                '• Responsive Shopping App: Developed a cross-platform shopping app using Flutter and Dart, enhancing user engagement by 25% with a responsive and intuitive UI design.\n• Backend Architecture: Architected a robust backend using PHP and MySQL, with XAMPP server for local development and testing, supporting over 1000 concurrent users seamlessly.\n• Secure Authentication: Implemented secure user and admin authentication systems, ensuring data privacy and security for all users.\n• Enhanced Product Search: Optimized product search functionality, improving search efficiency by 40% and reducing order processing time by 35%.\n• Imgur API Integration: Boosted user interaction by 20% through the integration of the Imgur API, allowing users to upload and share product images easily.\n• Cross-Platform Compatibility: Ensured a 98% crash-free experience by thoroughly testing and debugging the app for cross-platform compatibility, providing a smooth user experience across Android and iOS devices.',
                '20',
                'https://github.com/sanjiv0286/EasyCart-App',
              ),
              projectCard(
